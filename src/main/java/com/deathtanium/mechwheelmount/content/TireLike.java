...
public record TireLike(float radius, Vec3 rotation, Vec3 offset, Optional<ResourceLocation> model) {
    ...
    public static final TireLike ROCKCUTTING_WHEEL = new TireLike(0.8f);
    public static final TireLike MECHANICAL_ROLLER = new TireLike(0.7f, Vec3.ZERO, new Vec3(0, -0.5f, 0), (ResourceLocation) null);
}
